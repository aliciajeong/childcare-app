...
const courses: LawCard[] = [
  ...
  { badge: "중급 자격", badgeColor: "bg-emerald-100 text-emerald-700", title: "CHC50121 — Diploma of Early Childhood Education and Care", content: "교사 비율에서 '자격을 갖춘 교육자'로 인정. Room Leader 역할. Level 4 시급 적용. Graduate Diploma 진학 시 유리. 교육 프로그램 설계·평가, 팀 리더십 포함.", updated: "Children's Services Award Level 4 적용" },
  { badge: "ECT 자격", badgeColor: "bg-blue-100 text-blue-700", title: "Bachelor of Education (Early Childhood) / ECT 자격", content: "Early Childhood Teacher (ECT) 자격. Level 5 이상 시급. 각 서비스에 최소 1명의 ECT 배치 의무 (중심 기반 서비스 기준). 교사 비율 충족, 교육 프로그램 주도.", updated: "Children's Services Award Level 5+ 적용" },
